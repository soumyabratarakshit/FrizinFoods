...
<div class="container">
            ...
            <div class="panel panel-default credit-card-box customwidth center-block">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        ...
                        <h3 class="panel-title display-td" ><br></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWe Thank You For Shopping With Us...</h3>
 ...
 <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <h3>Your Billed Amount is Rs. <?php echo $pay; ?>&nbsp&nbsp&nbsp Your order has just been started packing.&nbsp&nbsp&nbsp Your order will be delivered in the next 60 minutes...</h3>
   ...
   <div class="row">
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                  <h3>Delivery &nbsp&nbsp&nbspDetails</h3>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h5>Name &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $name; ?></h5>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h5>Email &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?php echo $email ?></h5>
                                </div>
                            </div>                        
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h5>Address &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $address; ?></h5></h5>
                                </div>
                            </div>                        
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h5>City &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $city; ?></h5></h5>
                                </div>
                            </div>                        
                        </div>
                        <div class="form-group">
                            <div class="col-xs-5">
                                <div class="form-group">
                                  <h5>Pincode &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $pin; ?></h5></h5>
                                  <h5>Contact Number &nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $mobno; ?></h5></h5>
                                </div>
                            </div>                        
                        </div>
           ...
           <a href="index.php"><h4>RETURN HOME</h4></a> </button>
