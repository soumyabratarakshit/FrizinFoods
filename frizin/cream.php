    ...
    ==========================================-->
     ...
     <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/35.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Fresh Cream</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"> <h3>Pack Price</h3><h1>  ₹. 190</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>Pack Size</strong> - <em>1 Litre</em>
                            </li>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Fresh Cream </p>
                        <li>Packed with energy and nutrition that's essential for growing kids.</li>
                        <li>Cream is a dairy product composed of the higher-butterfat layer skimmed from the top of milk before homogenization.</li>
                        <li>Cream Milk delivers on the promise of creaminess and goodness you can really taste. It's the best quality and creamiest taste for you and your family.</li>
            ...
            <a href="cheese.php">
             ...
             <a href="sourcurd.php">
             <img src="img/portfolio/36.jpg"  height="200px" width="200px">
        </div>
    </div>
