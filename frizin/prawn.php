    ...
    ==========================================-->
       ...
       <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/15.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Prawns(Medium Size)</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"><h3>Pack Price</h3><h1>  ₹. 610</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
                            ...
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>No. of Pieces</strong> - <em>8-10</em>
                            </li>
                            <br></br>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Prawns---seawater species </p>
                        <li>Cook them any style with the tail on only and you'll still be a prawnomenal success. The half kg box includes 20 to 24 pieces of fresh prawns that are cleaned and de-veined.</li>
                        <li>Turn up the heat, throw in the prawns and fry for a few mins, stirring, until all theprawns turn pink.</li>
                        <li> Take off the heat, season and stir in the lemon juice.</li>
                        <li>Caloric value is about (1150-1200 kcal/kg).</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="rohu.php">
             ...
             <a href="pomphret.php">
             <img src="img/portfolio/16.jpg"  height="200px" width="200px">
        </div>
    </div>
