    ...
    ==========================================-->
      ...
      <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/19.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Juicy Chicken Tikka</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"><h3>Pack Price</h3><h1>  ₹. 160</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>Pack Size</strong> - <em>350 g</em>
                            </li>
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>No. of Pieces</strong> - <em>4</em>
                            </li>
                            <br></br>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Juicy chicken tikka--paranoid & garlic</p>
                        <li>Delve into the Royal chicken tikka flavoured soft kebabs with a hint of spice. </li>
                        <li>Easy to go on the pocket</li>
                        <li>Hassle-free delicacy just at your table!!</li>
                        <li>If righteous anger were a food, this would be it.</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="fishcutlet.php">
             <img src="img/portfolio/20.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
             <a href="muttseekh.php">
             <img src="img/portfolio/21.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="muttbiryani.php">
             <img src="img/portfolio/22.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="butterchicken.php">
             <img src="img/portfolio/23.jpg"  height="200px" width="200px">
        </div>
    </div>
