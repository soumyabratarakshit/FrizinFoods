        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="index.php" class="page-scroll">Contact</a></li>
             ...
             <li><a href="login.html" class="page-scroll"> <?php echo $_SESSION['email'] ?> </a></li> 
            <?php } else { ?>             
...
<!-- About Us Page
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/04.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Whole Chicken Skinless</strong></h2>
                            <hr>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Whole chicken skinless- perfect juicy meat & crispy chicken</p>
                        <li>It is on the way to cook your favourite dishes.</li>
                        <li>Stress-free weeknight meal</li>
                        <li>Roasted chicken is classical family recipe for every indian</li>
                        <li>Whole chicken recipe is like a butter ifused invitation to belly up to the   Sunday dinner</li>
                    </div>
                </div>
            </div>
            <br></br>
           ...
           <a href="chicwings.php">
             ...
             <img src="img/portfolio/08.jpg"  height="200px" width="200px">
        </div>
    </div>
