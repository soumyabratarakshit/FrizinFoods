      ...
      <?php $orderid = 2 ?>
       <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/02.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Chicken Cut(Boneless)</strong></h2>
                            <hr>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Chicken boneless:-spicy and yummy!!</p>
                        <li>Healthy,tasty boneless chicken with thin cut</li>
                        <li>Cook up super fast in a butter lemon sauce perfect for a weeknight meal</li>
                        <li>Keep your hunger alive!!</li>
                        <li>We are on the way!</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="chickeema.php">
             ...
             <img src="img/portfolio/06.jpg"  height="200px" width="200px">
        </div>
    </div>
