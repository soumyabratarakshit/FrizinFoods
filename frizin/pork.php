...
<!-- About Us Page
    ...
    <div id="tf-about">
        <div class="container">
            ...
            <br></br>
            <h2 style="font-family:helvetica;">SELECT FROM A WIDE RANGE OF <span style="color:orange;">PORK</span> ITEMS...</h2><br></br>
            <br></br>
            <div class="col-md-3 product-model-sec">

            <a href="porkribs.php">
             <img src="img/portfolio/38.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
            ...
            <a href="porkboneless.php">
             <img src="img/portfolio/39.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
              <div class="product-info-cust">
            ...
            <a href="porkbone.php">
             <img src="img/portfolio/40.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
              <div class="product-info-cust">
