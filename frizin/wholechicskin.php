                ...
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            ...
                            <h2><strong>Whole Skin Chicken (Skin)</strong></h2>
                            <hr>
                        ...
                        <ul class="about-list">
                            ...
                            <li>
                                ...
                                &nbsp&nbsp&nbsp<strong>Pack Size</strong> ~ <em>1 kg</em>
                            </li>
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>No. of Pieces</strong> - <em>1</em>
                            </li>
                            <br></br>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Whole skin chicken-light meat & juicy</p>
                        <li>Fried or roasted chicken is super delicious with the skin on</li>
                        <li>Fat contain is very low (2-3.7%) with creamy surface</li>
                        <li>A great roasted or baked chicken has to have crispy chicken skin</li>
            ...
            <a href="chicwings.php">
             <img src="img/portfolio/05.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
             <a href="chicbone.php">
             <img src="img/portfolio/07.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="chic8pc.php">
             <img src="img/portfolio/26.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="wholechicskinless.php">
             <img src="img/portfolio/04.jpg"  height="200px" width="200px">
        </div>
    </div>
