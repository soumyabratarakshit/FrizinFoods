      ...
      <?php $orderid = 6 ?>
       <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/06.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Chicken Breast(Boneless)</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"><h1>   ₹. 135</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
                            ...
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>No. of Pieces</strong> - <em>2-3</em>
                            </li>
                            <br></br>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Chicken Breast-Light Diet & Saucy!</p>
                        <li>Increasing your calories can be good at times.</li>
                        <li>Chicken Breast is really versatile cut of chicken.</li>
                        <li>It is a white meat with very little fat & easy to cook</li>
                        <li>You can bake it whole,breadcrumb it.</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="wholechicskin.php">
             <img src="img/portfolio/08.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
             <a href="chicliver.php">
             <img src="img/portfolio/25.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="chic8pc.php">
             ...
             <a href="chiclegs.php">
             <img src="img/portfolio/30.jpg"  height="200px" width="200px">
        </div>
    </div>
