...
$sql = "SELECT  userid,username,email,address,mobno,pin FROM USERS";
...
<!-- About Us Page
    ...
    <div id="tf-about">
        <div class="container">
          ...
          <span class="glyphicon glyphicon-shopping-cart"></span> <a href="logout.php">LOG OUT</a> </button>
                ...
                <br></br> <br></br> 
                   <img src="img/02.jpg" height="560" width="520">
