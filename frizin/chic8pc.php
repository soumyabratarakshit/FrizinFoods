    ...
    ==========================================-->
     ...
     <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/26.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Chicken 8 Pieces Cut</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"><h3>Pack Price</h3><h1>  ₹. 100</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
