...
<!-- About Us Page
    ==========================================-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/13.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Catla Fish(With Head)</strong></h2>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro"><h3>Pack Price</h3><h1>  ₹. 110</h1></p>
                        <ul class="about-list">
                            <br></br>
                            <li>
                            ...
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>No. of Pieces</strong> - <em>6-8</em>
                            </li>
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                &nbsp&nbsp&nbsp<strong>Cut Specification</strong> - <em>Bengali Cut</em>
                            </li>
                            <br></br>
...
<form action = "<?php echo $cart ?>" method = "post">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-shopping-cart"></span> ADD TO CART
                        ...
                        <br></br>
                        <p> Catla fish-- Freshwater Fish</p>
                        <li>The prized head and tail of the fish come intact with this cut</li>
                        <li>Cut Specification : Bengali Cut 6-8 pcs</li>
                        <li>Catla (katla), also known as the major (Indian) carp, is an economically important South Asian freshwater fish in the carp family</li>
                        <li>Highly caloric value about (800-880kcal/kg)</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="rohu.php">
             ...
             <a href="pomphret.php">
             <img src="img/portfolio/16.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             <a href="salmon.php">
