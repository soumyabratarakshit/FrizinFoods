    ...
    ==========================================-->
     ...
     <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/portfolio/01.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            
                            <h2><strong>Chicken Drumsticks</strong></h2>
                            <hr>
                ...
                <input type="button" id="mon_basmati_val" value = "0" size="1px">
...
document.getElementById("mon_basmati_plus").addEventListener("click", function(){
     ...
     document.getElementById("mon_basmati_val").value = parseInt(s) + 1;
                        ...
                        <br></br>
                        <p> Chicken Drumsticks - Tender and Juicy </p>
                        <li>At home one would do anything for a bite of the tangdi</li>
                        <li>Easy to go on the pocket</li>
                        <li>Hassle-free tangdis just at your table!!</li>
                        <li>Soft & sinfully succulent, you just cannot stop chomping on these delectable drumsticks.</li>
                    </div>
                </div>
            </div>
            <br></br>
            ...
            <a href="chicboneless.php">
             <img src="img/portfolio/02.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
             <a href="chickeema.php">
             <img src="img/portfolio/03.jpg"  height="200px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
