...
<li><img src="img/logo.png" height="40px"; width="40px"></li><li><a class="page-scroll" style="color:green; font-family:impact; font-size:20px;">9933 12 45 12</a></li>
            <li><a href="cart.php" class="page-scroll"> <img src="img/cart1.png" width="30" height="30"></a></li>          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
...
<!-- About Us Page
    ...
    <div id="tf-about">
        <div class="container">
            ...
            <br></br>
            <h2 style="font-family:helvetica;">SELECT FROM A WIDE RANGE OF <span style="color:orange;">MUTTON</span> ITEMS...</h2><br></br>
            <br></br>
            <div class="col-md-3 product-model-sec">

            <a href="muttbone.php">
             <img src="img/portfolio/09.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
...
<div class="col-md-3 product-model-sec">
            ...
            <a href="muttboneless.php">
             <img src="img/portfolio/10.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
              <div class="product-info-cust">
                <h5 style="color:black; font-family:verdana";>MUTTON CHOPS (BONELESS) </h5>
...
<div class="col-md-3 product-model-sec">
            ...
            <a href="muttkeema.php">
             <img src="img/portfolio/11.jpg"  height="260px" width="200px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <br></br>
              <div class="product-info-cust">
